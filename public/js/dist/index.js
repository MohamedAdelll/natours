...
})({"7FFim":[function(require,module,exports,__globalThis) {
...
if (bookBtn && Stripe) bookBtn.addEventListener('click', (e)=>{
...
const login = async (email, password)=>{
    try {
        ...
        } else (0, _alerts.showAlert)('error', data.message);
    } catch (err) {
        (0, _alerts.showAlert)('error', "Something went wrong! Couldn't log in.");
    }
};
const logout = async ()=>{
    try {
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === 'success') (0, _alerts.showAlert)('success', `${type[0].toUpperCase() + type.slice(1)} updated successfully!`);
    } catch (err) {
...
const stripe = Stripe('pk_test_51MUpsDIgjR6iJF4FPUkZHsOJIxY0wTP8wAD3rPyBmXuLBJKuoVAnCmObWVqudYaHGBZ0uYxtqfFxiEuRngebEN7000U6WwO3RX');
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7FFim","f2QDv"], "f2QDv", "parcelRequire94c2")
